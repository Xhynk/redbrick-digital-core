<?php
	...
	*/
	...
	$meta			= "<span class='meta small relative' style='$_font_color'><span><a target='_blank' href='$_url' style='$_font_color text-decoration: none;'><span>$_total_reviews</span> Reviews</a></span></span>";
	...
	echo $args['before_widget']; ?>
		<div class="rbd-core-ui">
			<div class="rbd-reviews-social-proof minimal" style="text-align: <?php echo $text_align; ?>;">
